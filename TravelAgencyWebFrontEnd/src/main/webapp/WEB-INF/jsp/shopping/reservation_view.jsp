...
<jsp:attribute name="body">
    ...
    <div class="row">
        <div class="col-xs-5">
            <h2>
                <a href="${pageContext.request.contextPath}/shopping/trip/${reservation.trip.id}">
                    <c:out value="${reservation.trip.name}"/>
                </a>
            </h2>
            <h4>
                Destination: <c:out value="${reservation.trip.destination}"/>
            </h4>
            <h4>
                Date:
                <fmt:formatDate value="${reservation.trip.dateFrom}" pattern="dd.MM.yyyy"/>
                -
                <fmt:formatDate value="${reservation.trip.dateTo}" pattern="dd.MM.yyyy"/>
            </h4>
            <h4>
                ...
                <c:forEach items="${reservation.excursions}" var="excursion">
                    <tr>
                        ...
                        <td>
                           ...
                           -
                           <fmt:formatDate value="${excursion.dateTo}" pattern="dd.MM.yyyy"/>                        </td>
                        <td>
