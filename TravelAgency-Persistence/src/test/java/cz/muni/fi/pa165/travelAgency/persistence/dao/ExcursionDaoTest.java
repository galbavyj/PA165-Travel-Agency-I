...
public class ExcursionDaoTest extends AbstractTestNGSpringContextTests{
    ...
    public void setup() {
        ...
        calendar.set(2017, Calendar.APRIL, 19, 8, 0);
        ...
        trip1.setAddressOfHotel(new Address());
    ...
    public void update(){
        excursionDao.create(excursion1);
        assertEquals(excursionDao.findExcursionById(excursion1.getId()).getPlace(), "London");
        excursion1.setPlace("Amsterdam");
        excursionDao.update(excursion1);
        assertEquals(excursionDao.findExcursionById(excursion1.getId()).getPlace(), "Amsterdam");
    ...
    /*@Test
    public void findAllExcursionsInReservation() throws Exception {

    }*/

    /*@Test
    public void excursionInTrip(){
        excursionDao.create(excursion1);
        tripDao.create(trip1);
        assertTrue(excursionDao.findExcursionById(excursion1.getId()));
    ...
    public void testCreateWithZeroTripDuration() {
        excursion1.setDurationInHours(-1);
        excursionDao.create(excursion1);
    }*/
